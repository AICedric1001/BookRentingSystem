...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 13, 2024 at 08:41 AM
...
(3, 'H.P Lovecraft: The Call of Cthulhu', 'Horror', 45);
...
--
ALTER TABLE `renteraccount`
  MODIFY `PersonID` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
